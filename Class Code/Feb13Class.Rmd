...
Ctrl + Alt + I = include code chunk Ctrl + shift + m = include pipe operator
...
*1. Implement your own function for craps, but simulating unfair dice, where each die is loaded in the following way:* \* *Each of 2, 3, 4, 5 are twice as likely as a 1.* \* *A 6 is four times as likely as a 1.*
...
hist(estimates100)
abline(v = mean(estimates100), lwd = 2, col = "blue") # mean = 0.5261


hist(estimates1000)
abline(v = mean(estimates1000), lwd = 2, col = "blue") # mean = 0.52288


hist(estimates10_000)
abline(v = mean(estimates10_000), lwd = 2, col = "blue") # mean = 0.523843
