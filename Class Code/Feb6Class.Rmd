...
```{r}
set.seed(8675309) # or your favorite integer > 0 
uvals5 <- runif(n = 5)
uvals <- runif(n = 100) # generate 5 uniform(0,1) variates 
igamma(uvals5, shape = 2, scale = 0.5, showPDF = TRUE, plotDelay = 0.5, showECDF = TRUE) 
#igamma(uvals, shape = 2, scale = 0.5, showPDF = TRUE, plotDelay = 0.5, showECDF = TRUE) 
#Repeat the process also showing the empirical CDF by including showECDF = TRUE in the argument list.
